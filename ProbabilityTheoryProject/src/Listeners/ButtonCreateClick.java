        ...
        if ((kolTheory > 0 || kolPractice > 0) && !strQuantity.isEmpty() && strQuantity.charAt(0) != '0' && (radioButtonMany.isSelected() || radioButtonOne.isSelected()) && !strSave.isEmpty())
        {
            ...
            if (radioButtonMany.isSelected())
            {
                ...
                for (int i = 1; i <= kol; i++)
                {
                    ...
                    {
                        PracticeTask2 practiceTask2 = new PracticeTask2(poiMainClassVariant, poiMainClassAnswers);
                    ...
                    {
                        PracticeTask4 practiceTask4 = new PracticeTask4(poiMainClassVariant, poiMainClassAnswers);
